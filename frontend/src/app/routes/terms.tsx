  ...
  return (
    <>
      <Head
        ...
        description="Read the Terms and Conditions for using devlinks, our friendly link-sharing platform. Understand your rights, responsibilities, and how we work together to keep devlinks a safe and enjoyable space for everyone."
      />
      <section className="flex flex-col gap-10 max-w-[720px] px-6 py-20 mx-auto text-dark_grey ">
        ...
        <div>
          ...
          <p>
            ...
            (&quot;Terms&quot;) govern your use of our platform. By signing up
            for an account or using devlinks, you agree to these Terms, so
        ...
        <div>
          ...
          <p className="mb-5">
            ...
            sign-up, we&apos;ll ask for some basic information such as an email
            and password. This helps personalize your experience and keep your
            account secure.
          </p>
          ...
          <p className="mb-5">
            ...
            Please choose a strong password and don&apos;t share it with others.
            If you suspect any unauthorized use of your account, let us know
            right away.
          </p>
          ...
          <p>
            ...
            respectful when using the platform. This means no harmful content,
            no impersonating others, and no using devlinks for anything illegal.
        ...
        <div>
          ...
          <p className="mb-5">
            ...
            and social links, is yours. You retain full ownership of your
            content. By uploading it to devlinks, you grant us a non-exclusive
            license to display and share it as part of the service.
          </p>
          ...
          <p>
            ...
            content that you didn&apos;t create, make sure you have permission
            to use them.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mb-5">
            To help you create your profile and manage your links, we collect
            some personal information like your name, username, profile picture,
          ...
          <p className="mb-5">
            Your data is used to personalize your profile and let others see
            what you want to share.
          </p>
          <h3 className="text-xl font-semibold mb-2">Keeping Your Data Safe</h3>
          <p>
            We care about your privacy and take steps to protect your
            information. While no system is 100% secure, we do our best to keep
        ...
        <div>
          ...
          <p className="mb-5">
            ...
            the service will be free of errors or interruptions, but we&apos;ll
            do our best to fix any issues that arise.
          </p>
          <h3 className="text-xl font-semibold mb-2">
        ...
        <div>
          ...
          <p className="mb-5">
            If you ever decide to stop using devlinks, you can delete your
            account at any time. We&apos;ll be sad to see you go, but we
            understand!
          </p>
          <h3 className="text-xl font-semibold mb-2">
          ...
          <p>
            ...
            these Terms. We&apos;ll do our best to be fair, and we&apos;ll let
        ...
        <div>
          ...
          <p>
            ...
            our service or for other operational, legal, or regulatory reasons.
            If we make changes, we&apos;ll notify you by posting the new Terms
            on our website. Your continued use of devlinks after these changes
        ...
        <div>
          ...
          <p className="mb-5">
            ...
            <a
              href="mailto:devlinks.fun@gmail.com"
              className="font-semibold text-purple"
            >
              devlinks.fun@gmail.com
            </a>
          </p>
        </div>
      </section>
