import illusEmpty from '@/assets/illustrations/illustration-empty.svg';

export default function GetStarted() {
  return (
    <div className="bg-grey-light rounded-xl mx-6 md:mx-10 px-5 py-[46.5px] sm:py-[82.5px] lg:py-[62.5px]">
      <div className="relative w-[125px] h-[80px] sm:w-[250px] sm:h-[161px] mx-auto mb-6 sm:mb-10">
        <img src={illusEmpty} alt="Get Started" />
      </div>
